...
describe("StateVariables: ", function () {
  ...
  it("Should Get the values from state variable", async function () {
    ...
    await this.deployedStateVariable.getPrivateAgeNew();
    ...
    // await this.deployedStateVariable.doSomeWork4(78);
    await this.deployedStateVariable.doAcceptEther(this.reciever.address,{
      value: 1
    });
